...
Phân tích bộ nhớ (Memory analysis)
   B
 ạn cần nắm vững cách tính toán lượng bộ nhớ tiêu thụ của một lớp (class) dựa trên mô hình bộ nhớ 64-bit được hướng dẫn trong sách giáo trình.
   P
hân tích lý thuyết và thực nghiệm (Theoretical and empirical analysis)
   C
ác giả thuyết được tạo ra từ phân tích lý thuyết (hoặc từ các phỏng đoán như giả thuyết định luật lũy thừa của chúng ta) cần phải được xác thực bằng dữ liệu thực tế trước khi có thể hoàn toàn tin cậy.
